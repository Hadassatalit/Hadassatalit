...
<body>
  <div style="text-align: center;">
    <h2>Oiii, Eu sou Hadassa Talita!</h2>
    <ul>
      <li>Estudante de Análise de Sistemas</li>
      <li>Interessada em front-end, explorando também o back-end</li>
      <li>Buscando aprender na prática com projetos e estudos</li>
      <li>Criando este espaço para organizar e compartilhar meu progresso</li>
    </ul>
  </div>
